...
public class CommentController {
    ...
    public ResponseEntity<CommentDto> crerateComment(@PathVariable("postId") long postId, @RequestBody CommentDto commentDto){
    ...
    public ResponseEntity<String> deleteComments(@PathVariable("postId") long postId, @PathVariable("id") long commentId){
